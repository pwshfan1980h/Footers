...
// --- Shared Color Palette (Cantina) ---
export const SPACE_BLACK = 0x1a0e08;
export const HULL_DARK = 0x1a1510;
export const NEON_CYAN = 0xFFBB44;
export const NEON_PINK = 0xFF8844;

// --- Day Names ---
export const DAY_NAMES = ['', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];

// --- Stack Layer Heights (pixels) ---
export const LAYER_HEIGHT_SAUCE = 4;
...
export const TICKET_FONT = 'Orbitron';
