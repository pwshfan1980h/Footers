export const INGREDIENTS = {
  ...
  meat_bacon:      { key: 'meat_bacon',      name: 'Bacon',    category: 'meat',    color: 0xCC3322, border: 0x991A11, textColor: '#fff' },
...
export const BIN_LAYOUT = [
  ['bread_white', 'bread_wheat', 'meat_ham', 'meat_turkey', 'meat_roastbeef', 'meat_bacon'],
